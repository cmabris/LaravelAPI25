    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="products">
                    <a href="#products">Products</a>
                                ...
                                <a href="#products-GETapi-products">Get categories</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<div class="bash-example">
    ...
    --get "http://localhost:8000/api/lists/categories?page=12" \
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: [
        {
            &quot;id&quot;: 1,
            &quot;name&quot;: &quot;Sou la primera categor&iacute;a&quot;
        },
        {
            &quot;id&quot;: 2,
            &quot;name&quot;: &quot;consequatur aspernatur fugit&quot;
        },
        {
            &quot;id&quot;: 3,
            &quot;name&quot;: &quot;quia qui earum&quot;
        ...
        {
            &quot;id&quot;: 4,
            &quot;name&quot;: &quot;pariatur reiciendis dolor&quot;
        },
        {
            &quot;id&quot;: 5,
            &quot;name&quot;: &quot;beatae atque quis&quot;
        },
        {
            &quot;id&quot;: 6,
            &quot;name&quot;: &quot;dolores rerum dignissimos&quot;
        },
        {
            &quot;id&quot;: 7,
        ...
        {
            &quot;id&quot;: 8,
            &quot;name&quot;: &quot;quae voluptate sed&quot;
        },
        {
            &quot;id&quot;: 9,
            &quot;name&quot;: &quot;dicta mollitia dolores&quot;
        },
        {
            &quot;id&quot;: 10,
            &quot;name&quot;: &quot;ab magnam eos&quot;
        ...
        {
            &quot;id&quot;: 14,
            &quot;name&quot;: &quot;Solo soy el nombre&quot;
        },
        {
            &quot;id&quot;: 15,
            &quot;name&quot;: &quot;Soy una categor&iacute;a con foto&quot;
        }
    ]
}</code>
 </pre>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               step="any"               name="page"                data-endpoint="GETapi-lists-categories"
               value="12"
...
<div class="bash-example">
    ...
    "http://localhost:8000/api/categories?page=12" \
    --header "Content-Type: application/json" \
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="page"                data-endpoint="POSTapi-categories"
               value="12"
               data-component="query">
    <br>
<p>Which page to show. Example: <code>12</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Name of the category. Example &quot;Clothing&quot; Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Description of the category. Example: <code>Eius et animi quos velit et.</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/categories/1?page=12" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="page"                data-endpoint="GETapi-categories--id-"
               value="12"
               data-component="query">
    <br>
<p>Which page to show. Example: <code>12</code></p>
...
<div class="bash-example">
    ...
    "http://localhost:8000/api/categories/1?page=12" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"architecto\"
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="page"                data-endpoint="PUTapi-categories--id-"
               value="12"
               data-component="query">
    <br>
<p>Which page to show. Example: <code>12</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="page"                data-endpoint="DELETEapi-categories--id-"
               value="12"
               data-component="query">
    <br>
<p>Which page to show. Example: <code>12</code></p>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>Managing products</p>
                                ...
                                <h2 id="products-GETapi-products">Get categories</h2>

<p>
</p>

<p>Getting the list of the products</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/products?page=12" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
